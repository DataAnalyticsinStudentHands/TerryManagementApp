 ...
 */
angular.module('Controllers').controller('DashCtrl', function ($scope, $filter, $ionicModal, $ionicPopup, $stateParams, DataService, item) {
    'use strict';
    ...
    // GET 
    /*DataService.getItem('applications', $stateParams.itemId).then(
        function (result) {
            $scope.item = result;
        }
    );*/
    ...
    $scope.createPdf = function () {
        ...
        var docDefinition = {
            content: [
                ...
                {
                    text: 'Terry Foundation Scholarship Program Application 2015-2016',
                    style: 'subheader'
                },
                {
                    style: 'tableExample',
